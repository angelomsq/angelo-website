        ...
        {github && (
          <li className="pb-8 last:pb-0">
            <Link href={github} target="_blank" className="group">
              <FaGithub size={32} className="transition-all ease-in group-hover:text-primary" />
            </Link>
          </li>
        )}
        ...
        {linkedin && (
          <li className="pb-8 last:pb-0">
            <Link href={linkedin} target="_blank" className="group">
              <FaLinkedinIn size={32} className="transition-all ease-in group-hover:text-primary" />
            </Link>
          </li>
        )}
        ...
        {instagram && (
          <li className="pb-8 last:pb-0">
            <Link href={instagram} target="_blank" className="group">
              <FaInstagram size={32} className="transition-all ease-in group-hover:text-primary" />
            </Link>
          </li>
        )}
        ...
        {whatsapp && (
          <li className="pb-8 last:pb-0">
            <Link href={whatsapp} target="_blank" className="group">
              <FaWhatsapp size={32} className="transition-all ease-in group-hover:text-primary" />
            </Link>
          </li>
        )}
        ...
        {youtube && (
          <li className="pb-8 last:pb-0">
            <Link href={youtube} target="_blank" className="group">
              <FaYoutube size={32} className="transition-all ease-in group-hover:text-primary" />
            </Link>
          </li>
        )}
        ...
        {discord && (
          <li className="pb-8 last:pb-0">
            <Link href={discord} target="_blank" className="group">
              <FaDiscord size={32} className="transition-all ease-in group-hover:text-primary" />
            </Link>
          </li>
        )}
      </ul>
      <div className="hidden h-full w-[3px] flex-1 rounded-full bg-tertiary dark:bg-white sm:flex">
        &nbsp;
      </div>
    </header>
  )
